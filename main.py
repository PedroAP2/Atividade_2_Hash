...
"sha256": "d24de3ec3835115c576a55188a31761b73af93ed2c45a171c810bb66b24b08f9", "md5": "c850e1a34a6ed572e0758ccd9c615bda"},
{
...
for dict in listofdicts:
  ...
  print("\"" +text)
  if dict["sha256"] == SHA256:
    print("\" - " + SHA256 + " SHA256 OK")
  else:
    print("\" - " + SHA256 + " SHA256 NOT OK")
    print(dict["sha256"])

  if dict["md5"] == MD5:
    print("\" - " + SHA256 + " MD5 OK")
  else:
    print("\" - " + SHA256 + " MD5 NOT OK")
    print(dict["md5"])
